...
## TEMPLATE: Text and image grid with subheadings {.shell-slide}
...
## TEMPLATE: Fit panels (good / bad) {.shell-slide}
...
## TEMPLATE: Flow row — 3 steps {.shell-slide}
...
## TEMPLATE: Flow row — 5 steps {.shell-slide}
...
## TEMPLATE: Contact grid {.shell-slide}
...
## TEMPLATE: Case study {.case-study-slide}
