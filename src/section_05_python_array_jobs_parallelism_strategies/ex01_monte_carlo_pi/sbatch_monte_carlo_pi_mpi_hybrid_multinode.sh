#!/bin/bash
#SBATCH --job-name=mc_pi_py_mn
#SBATCH --output=mc_pi_py_mn_%j.out
#SBATCH --nodes=4
#SBATCH --exclusive
#SBATCH --time=00:02:00

# Weak-scaling companion to sbatch_monte_carlo_pi_mpi_hybrid.sh (single node).
#
...
#     └── Numba threads (shared memory, within one node)
#
...
# Numba thread synchronisation on this hardware.
