/* matmul_naive.c — matrix multiply using a hand-rolled ikj triple loop (double precision) */
...
int main(int argc, char** argv)
{
    ...
    printf("matmul routine=naive ikj triple loop (double) N=%d OMP_NUM_THREADS=%s\n", n,
